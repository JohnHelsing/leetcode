...
//
// 如果 firstWord 和 secondWord 的 数值之和 等于 targetWord 的数值，
// 返回 true ；否则，返回 false 。
//
// 
//
...
public class Q1880_CheckIfWordEqualsSummationOfTwoWords {

    public static void main(String[] args) {
        Solution solution = new Solution();
        solution.isSumEqual("a", "b", "aaaaaaab");
    }
    ...
    class Solution {
        public boolean isSumEqual(String firstWord, String secondWord, String targetWord) {
            return sToN(firstWord) + sToN(secondWord) == sToN(targetWord);
        }

        private int sToN(String s) {
            int num = 0;
