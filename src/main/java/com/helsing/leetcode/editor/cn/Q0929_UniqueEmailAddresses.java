...
public class Q0929_UniqueEmailAddresses {

    public static void main(String[] args) {
        Solution solution = new Solution();
        String[] cas = {"test.email+alex@leetcode.com", "test.email@leetcode.com"};
        solution.numUniqueEmails(cas);
    }
