...
// 且二叉树中所有节点的值都是互不相同的。
//
// 我们扩展二叉树的最近公共祖先节点在维基百科上的定义：“对于任意合理的 i 值， n 个节点
// p1 、 p2、...、 pn 在二叉树 T 中的最近公共祖先
//节点是后代中包含所有节点 pi 的最深节点（我们允许一个节点是其自身的后代）”。
...
// 所有的 nodes[i] 都是互不相同的。 
// 
// Related Topics 树 深度优先搜索 二叉树 👍 18 👎 0

package com.helsing.leetcode.editor.cn;

import com.helsing.leetcode.common.bean.TreeNode;

public class Q1676_LowestCommonAncestorOfABinaryTreeIv {
